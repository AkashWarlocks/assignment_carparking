...
function ExitvehichleComponent_tr_52_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ExitvehichleComponent_tr_52_Template_button_click_12_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r4); const item_r1 = ctx.$implicit; const ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r3.emptySlot(item_r1); });
...
ExitvehichleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ExitvehichleComponent, selectors: [["app-exitvehichle"]], decls: 53, vars: 5, consts: [[1, "container"], [1, "row"], [1, "col-12"], [1, "card"], [1, "card-header", 2, "background", "#cfc48c"], [1, "form-heading", "text-center"], [1, "card-body"], [1, "table"], [1, "thead-dark"], [1, "form-heading-2", "text-center"], [4, "ngFor", "ngForOf"], [1, "btn", "btn-danger", 3, "click"]], template: function ExitvehichleComponent_Template(rf, ctx) { if (rf & 1) {
...
HomeComponentComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HomeComponentComponent, selectors: [["app-home-component"]], decls: 95, vars: 11, consts: [[1, "container"], [1, "row"], [1, "col-12"], [1, "card"], [1, "card-header"], [1, "form-heading-2", "text-center"], [1, "card-body"], [1, "col-sm-6"], [1, "card-header", 2, "background", "#cfc48c"], [1, "form", "login-form", 3, "formGroup", "submit"], ["for", "carType", 1, "Input-label"], ["formControlName", "carType", "placeholder", "Select Car Type", 1, "form-control"], ["value", "Motorcycle"], ["value", "Car"], ["value", "Bus"], ["for", "vehicleNo"], ["type", "text", "formControlName", "vehicleNo", "placeholder", "Enter Vehicle Number", 1, "form-control"], ["type", "submit", 1, "btn", "btn-primary", "float-right"], [1, "card-header", "background", 2, "background", "#cfc48c"], [1, "form-heading-2", "text-center", "p-1"], ["type", "submit", 1, "btn", "btn-danger", "float-right"]], template: function HomeComponentComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("submit", function HomeComponentComponent_Template_form_submit_38_listener() { return ctx.print(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("submit", function HomeComponentComponent_Template_form_submit_70_listener() { return ctx.getSinglevehicle(); });
